...
class FaceDetector:
    ...
    def __init__(self, args=None):
        """Initialization"""
        self.face_net = cv2.dnn.readNetFromCaffe(args.DNN_PROTO, args.DNN_MODEL)
...
class MarkDetector:
    ...
    def __init__(self, args=None):
        ...
        self.face_detector = FaceDetector(args=args)
        # self.face_detector.args = args
        self.cnn_input_size = 128
        self.marks = None
        print("*" * 100)

        # Restore model from the saved_model file.
        self.model = keras.models.load_model(args.SAVE_MODEL)
